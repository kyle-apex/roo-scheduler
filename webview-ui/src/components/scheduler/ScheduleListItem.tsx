...
interface ScheduleListItemProps {
  ...
  onDeleteRequest: (scheduleId: string) => void;
}

const ScheduleListItem: React.FC<ScheduleListItemProps> = ({ schedule, onEdit, onDeleteRequest }) => {
  return (
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={() => onDeleteRequest(schedule.id)}
